            ...
            <div className='d-flex justify-content-center'>
                <div className='col-lg-11'>
                    <div className='navbar bg-light navbar-expand-lg navbar-light d-flex'>
                        <a class='navbar-brand' href='#TEST'>SADIE</a>
                        ...
                        <div className='nav-links-container d-flex'>
                            <div className='btn-group'>
                                ...
                                <a href='#TEST' className='btn btn-secondary'>Artworks</a>
                            </div>
                            
                            <div className='input-group'>
                                <div className='input-group-prepend'>
                                    <a href='#TEST' className='input-group-text search-btn' id='btnGroupAddon'><i class='fa-solid fa-magnifying-glass'></i></a>
                                </div>
